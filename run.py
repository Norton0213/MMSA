...
from MMSA.config import get_config_regression, get_config_tune
from MMSA.data_loader import MMDataLoader
from MMSA.models import AMIO
from MMSA.trains import ATIO
from MMSA.utils import assign_gpu, count_parameters, setup_seed
#os.environ['CUDA_LAUNCH_BLOCKING'] = '1' # 下面老是报错 shape 不一致

os.environ["CUDA_DEVICE_ORDER"]="PCI_BUS_ID"
os.environ["CUBLAS_WORKSPACE_CONFIG"] = ":4096:2" # This is crucial for reproducibility
#os.environ["CUDA_VISIBLE_DEVICES"]="-1" ###不使用gpu，指定此处为-1即可


SUPPORTED_MODELS = [
    'LF_DNN', 'AVMFA-Conformer', 'TFN', 'LMF', 'MFN', 'Graph_MFN', 'MFM',
...
def _run(args, num_workers=0, is_tune=False, from_sena=False):
    ...
    if from_sena:
        ...
        results = trainer.do_missing_test(model, dataloader['test'], mode="TEST")
