...
class ConformerEncoder(BaseEncoder):
    ...
    def __init__(
        ...
        encoder_selfattn_layer_args = (#(4,256,0)
            attention_heads,
            output_size,
            attention_dropout_rate,
        )
        ...
        positionwise_layer_args = (#(256,2048,0.1,swish)
            output_size,
            linear_units,
            dropout_rate,
            activation,
        ...
        convolution_layer_args = (output_size, cnn_module_kernel, activation,#(256,15,swish,batchnorm,false)
