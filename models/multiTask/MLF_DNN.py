...
class MLF_DNN(nn.Module):
    ...
    def __init__(self, args):
        ...
        in_size = self.text_out + self.video_hidden + self.audio_hidden
        self.post_fusion_Conformer = conformer(n_mels=in_size, num_blocks=6, output_size=256, embedding_dim=self.post_fusion_dim,
    ...
    def forward(self, text_x, audio_x, video_x):
        audio_x = audio_x.squeeze(1)#(batchsize, 1, feature_dims)
        ...
        x = F.relu(self.post_fusion_Conformer(x), inplace=True)
